...
return [
    ...
    */
    ...
    'common' => [
        ...
        "total_deposit_without_interest"    => "Total Deposit Without Interest",
        "total_deposit_with_interest"       => "Total Deposit With Interest",
        "name"                              => "Name",
        "email"                             => "Email",
        "password"                          => "Password",
        ...
        "bank_check_no"                     => "Check No.",
        "address"                           => "Address",
        "present_address"                   => "Present Address",
        "permanent_address"                 => "Permanent Address",
        "street_address"                    => "House/Apartment/Road",
        "city"                              => "City",
        "word_no"                           => "Word/Union No.",
        ...
        "christian"                         => "Christian",
        "Buddhist"                          => "Buddha",
        "open_signature_pad"                => "Open Signature Pad",
        "signature_pad"                     => "Signature Pad",
        "signature"                         => "Signature",
        "approval"                          => "approval",
        "saving_info"                       => "Saving Info",
        "nominee_info"                      => "Nominee Info",
        "add_nominee"                       => "Add Nominee",
        "remove_nominee"                    => "Remove Nominee",
        "nominee"                           => "Nominee",
        "loan_info"                         => "Loan Info",
        "guarantor_info"                    => "Guarantor Info",
        "add_guarantor"                     => "Add Guarantor",
        "remove_guarantor"                  => "Remove Guarantor",
        "guarantor"                         => "Guarantor",
        "loan_given"                        => "Loan Given",
        "total_payable_loan_with_interest"  => "Total Loan with interest",
    ...
    /*
    |--------------------------------------------------------------------------
    | Common Validation Custom Message
    |--------------------------------------------------------------------------
    */
    'common_validation' => [
        'crossed_the_limitations' => 'crossed the limitations.',
    ],
    ...
    */
    'client' => [
        'choose_new_acc_no' => "Choose New Account no!",
        ...
        */
        'saving' => [
            ...
            'delete_request'    => 'The Saving Account delete request successfully stored.',
        ...
        */
        'loan' => [
            ...
            'delete_request'    => 'The Loan Account delete request successfully stored.',
    ...
    */
    'recycle_bin' => [
        ...
        'reassign_user_required'       => 'Please select a replacement staff before permanently deleting this staff.',
        'reassign_user_not_found'      => 'Selected replacement staff was not found or is inactive.',
        'reassign_user_same'           => 'Replacement staff must be different from the staff being deleted.',
