...
class ClientRegistrationUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'secondary_phone'                   => "sometimes|nullable|phone:BD",
            'image'                             => "sometimes|nullable|mimes:jpeg,png,jpg,webp|max:5120",
            'signature'                         => "sometimes|nullable",
            'share'                             => "required|integer",
            'annual_income'                     => "sometimes|nullable",
            'bank_acc_no'                       => "sometimes|nullable",
            'bank_check_no'                     => "sometimes|nullable",
            'present_address.street_address'    => 'required',
            'present_address.city'              => 'required',
            'present_address.word_no'           => 'sometimes|nullable|numeric',
            ...
            'permanent_address.word_no'         => 'sometimes|nullable|numeric',
