...
class SavingAccountStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $validations = [
            ...
            'nominees.*.image'                  => 'required_if:image_uri,|sometimes|nullable|mimes:jpeg,png,jpg,webp|max:5120',
            'nominees.*.image_uri'              => 'required_if:image,',
            'nominees.*.signature'              => 'sometimes',
            'nominees.*.address.street_address' => 'required',
            'nominees.*.address.city'           => 'required',
            'nominees.*.address.word_no'        => 'sometimes|nullable',
