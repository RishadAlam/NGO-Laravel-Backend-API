...
class LoanSavingWithdrawalActionHistory extends Model
{
    use HasFactory;
    ...
    /**
     * Relationship belongs to LoanSavingWithdrawal model
     *
     * @return response()
     */
    public function LoanSavingWithdrawal()
    {
        return $this->belongsTo(LoanSavingWithdrawal::class)->withTrashed();
    }
